		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					...
					'phoneMustStartWith5' => $is_arabic ? 'يجب أن يبدأ رقم الجوال بالرقم 5.' : __('Phone number must start with 5.', 'spada-core'),
					'phoneMustBe9Digits'  => $is_arabic ? 'يجب أن يتكون رقم الجوال من 9 أرقام' : __('Phone number must be 9 digits', 'spada-core'),
