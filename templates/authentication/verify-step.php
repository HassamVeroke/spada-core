...
<div class="spada-auth-view <?php echo (isset($initial_view) && 'verify' === $initial_view) ? 'is-active' : ''; ?>" id="spada-view-verify" data-view="verify">
	...
	<?php if ($is_whatsapp) : ?>
		<h2 class="spada-verify-heading" id="spada-verify-heading"><?php esc_html_e('Check your whatsapp account', 'spada-core'); ?></h2>
		<p class="spada-verify-subheading" id="spada-verify-subheading">
			<span id="spada-verify-prompt"><?php esc_html_e("We've sent a six digit code to your whatsapp account on", 'spada-core'); ?></span>
			<br />
			<strong id="spada-verify-target">05XXXXXXXX</strong>
		</p>
	<?php elseif ($is_sms) : ?>
		<h2 class="spada-verify-heading" id="spada-verify-heading"><?php esc_html_e('Check your messages', 'spada-core'); ?></h2>
		<p class="spada-verify-subheading" id="spada-verify-subheading">
			<span id="spada-verify-prompt"><?php esc_html_e("We've sent a six digit code to your mobile number", 'spada-core'); ?></span>
			<br />
			<strong id="spada-verify-target">05XXXXXXXX</strong>
		</p>
	<?php else : ?>
	...
	<form class="spada-verify-form" id="spada-otp-form" onsubmit="return false;">
		...
		<div class="spada-resend-wrap">
			<span id="spada-resend-prompt"><?php echo $is_whatsapp ? esc_html__("Didn't receive the message on whatsapp?", 'spada-core') : ($is_sms ? esc_html__("Didn't receive the message on number?", 'spada-core') : esc_html__("Didn't receive the email?", 'spada-core')); ?></span>
		...
		<a href="#" role="button" class="spada-btn-outline" id="spada-change-target-btn">
			<span id="spada-change-target-text"><?php echo ($is_whatsapp || $is_sms) ? esc_html__('Change Number', 'spada-core') : esc_html__('Change Email', 'spada-core'); ?></span>
		</a>
	</form>

	<!-- Hidden translatable templates for verify view per method (TranslatePress translates on server) -->
	<div class="spada-verify-content-template" style="display:none !important;" aria-hidden="true">
		<div data-verify-template="email">
			<span class="tpl-heading"><?php esc_html_e('Check your email address', 'spada-core'); ?></span>
			<span class="tpl-prompt"><?php esc_html_e("We've sent a six digit code to your email address", 'spada-core'); ?></span>
			<span class="tpl-change"><?php esc_html_e('Change Email', 'spada-core'); ?></span>
			<span class="tpl-resend"><?php esc_html_e("Didn't receive the email?", 'spada-core'); ?></span>
		</div>
		<div data-verify-template="whatsapp">
			<span class="tpl-heading"><?php esc_html_e('Check your whatsapp account', 'spada-core'); ?></span>
			<span class="tpl-prompt"><?php esc_html_e("We've sent a six digit code to your whatsapp account on", 'spada-core'); ?></span>
			<span class="tpl-change"><?php esc_html_e('Change Number', 'spada-core'); ?></span>
			<span class="tpl-resend"><?php esc_html_e("Didn't receive the message on whatsapp?", 'spada-core'); ?></span>
		</div>
		<div data-verify-template="sms">
			<span class="tpl-heading"><?php esc_html_e('Check your messages', 'spada-core'); ?></span>
			<span class="tpl-prompt"><?php esc_html_e("We've sent a six digit code to your mobile number", 'spada-core'); ?></span>
			<span class="tpl-change"><?php esc_html_e('Change Number', 'spada-core'); ?></span>
			<span class="tpl-resend"><?php esc_html_e("Didn't receive the message on number?", 'spada-core'); ?></span>
		</div>
	</div>
</div>